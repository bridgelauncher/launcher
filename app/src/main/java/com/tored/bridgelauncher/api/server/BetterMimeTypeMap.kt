...
// doing this because Kotlin's MimeTypeMap apparently differs between Android versions and doesn't include .js on Android 8
val BetterMimeTypeMap = mapOf(
    ".323" to "text/h323",
    ".3g2" to "video/3gpp2",
    ".3gp" to "video/3gpp",
    ".3gp2" to "video/3gpp2",
    ...
    ".hxx" to "text/plain",
    ".i" to "text/plain",
    ".ical" to "text/calendar",
    ".icalendar" to "text/calendar",
    ".ico" to "image/x-icon",
    ...
    ".isma" to "application/octet-stream",
    ".ismv" to "application/octet-stream",
    ...
    ".pst" to "application/vnd.ms-outlook",
    ...
    ".rvt" to "application/octet-stream",
    ...
    ".step" to "application/step",
    ".stp" to "application/step",
    ...
    ".webm" to "video/webm",
    ".webp" to "image/webp", /* https://en.wikipedia.org/wiki/WebP */
    ...
    ".xml" to "text/xml",
    ".xmp" to "application/octet-stream",
    ...
    "application/msaccess" to ".adp",
    "application/msword" to ".doc",
    "application/octet-stream" to ".bin",
    "application/onenote" to ".one",
    "application/postscript" to ".eps",
    "application/step" to ".step",
    "application/vnd.apple.keynote" to ".key",
    "application/vnd.apple.numbers" to ".numbers",
    "application/vnd.apple.pages" to ".pages",
    "application/vnd.ms-excel" to ".xls",
    "application/vnd.ms-powerpoint" to ".ppt",
    "application/vnd.ms-works" to ".wks",
    "application/vnd.visio" to ".vsd",
    "application/x-director" to ".dir",
    "application/x-msdos-program" to ".exe",
    ...
    "application/xml" to ".xml", // anomaly, .xml -> text/xml, but application/xml -> many things, but all are xml, so safest is .xml
    "audio/aac" to ".AAC",
    "audio/aiff" to ".aiff",
    "audio/basic" to ".snd",
    "audio/mid" to ".midi",
    "audio/mp4" to ".m4a", // one way mapping only, mime -> ext
    "audio/ogg" to ".ogg",
    "audio/ogg; codecs=opus" to ".opus",
    "audio/wav" to ".wav",
    "audio/x-m4a" to ".m4a",
    ...
    "image/jpeg" to ".jpg",
    "image/pict" to ".pic",
    "image/png" to ".png", // Defined in [RFC-2045], [RFC-2048]
    "image/x-png" to ".png", // See https://www.w3.org/TR/PNG/#A-Media-type :"It is recommended that implementations also recognize the media type "image/x-png"."
    "image/tiff" to ".tiff",
    "image/x-macpaint" to ".mac",
    "image/x-quicktime" to ".qti",
    ...
    "video/vnd.dlna.mpeg-tts" to ".m2t",
    "video/x-dv" to ".dv",
