...
fun <TValue> ViewModel.collectAsStateButInViewModel(flow: StateFlow<TValue>) = mutableStateOf(flow.value).apply { viewModelScope.launch { flow.collectLatest { value = it } } }